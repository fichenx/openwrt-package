...
rm -rf dockerd docker containerd runc
git_sparse_clone master https://github.com/coolsnowwolf/packages utils/dockerd
#sed -i 's|\(PKG_VERSION:=\)[0-9]\+\.[0-9]\+\.[0-9]\+.*|\129.2.1|g' dockerd/Makefile
#sed -i 's|PKG_HASH:=.*|PKG_HASH:=4042ac63c7bb8af6c07880b8d10c82279e02ced2977a30890a4b3c729b29a937|g' dockerd/Makefile
#sed -i 's|PKG_GIT_REF:=v|PKG_GIT_REF:=docker-v|g' dockerd/Makefile
#sed -i 's/^GIT_REF=$(echo "$GIT_REF" | sed '\''s\/^docker-\/\/'\'')/#&/' dockerd/git-short-commit.sh
...
#sed -i 's|\(PKG_VERSION:=\)[0-9]\+\.[0-9]\+\.[0-9]\+.*|\129.2.1|g' docker/Makefile
#sed -i 's|PKG_HASH:=.*|PKG_HASH:=33a5c92198a2e57a6012c6f7938d69c72adf751584bc0c98d8d91e555b1c8f0a|g' docker/Makefile
...
#sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2.2.1/g' containerd/Makefile
#sed -i 's/PKG_HASH:=.*/PKG_HASH:=af5707a26891486332142cc0ade4f0c543f707d3954838f5cecee73b833cf9b4/g' containerd/Makefile
...
#sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.3.4/g' runc/Makefile
#sed -i 's/PKG_HASH:=.*/PKG_HASH:=a9f9646c4c8990239f6462b408b22d9aa40ba0473a9fc642b9d6576126495eee/g' runc/Makefile
