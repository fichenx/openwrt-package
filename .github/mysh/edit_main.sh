...
#注释掉svn export命令
#sed -i "s|^svn export|#svn export|g" .github/diy/main.sh
...
#/github.com/sirpdboy/netspeedtest|#git clone --depth 1 https://github.com/sirpdboy/netspeedtest|g" .github/diy/main.sh
